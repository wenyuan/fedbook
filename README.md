...
<p align="center">
  ...
  <img alt="updated" src="https://img.shields.io/badge/update-2024.05-blue.svg?style=flat-square">
  <img alt="license" src="https://img.shields.io/badge/license-CC BY NC 4.0-blue.svg?style=flat-square">
</p>

## 简介

[在线预览](https://wenyuan.github.io/)
...
随着工作学习的深入和拓展，本小册已由原先的「前端修炼小册」变更为「CODING 修炼小册」。

因为暂时没有想好 LOGO 用什么，故沿用之前的 FE（Front End）。
